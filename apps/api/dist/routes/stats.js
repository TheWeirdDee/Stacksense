...
async function getRecentEvents(n) {
    try {
...
async function getOnChainStats(signalId) {
    try {
...
async function refreshStats() {
    try {
        ...
        const eventsLast10m = events.filter(e => Date.now() - new Date(e.timestamp).getTime() < 10 * 60 * 1000).length;
